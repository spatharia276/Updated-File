...
import pyimg from '../img/pythonimg.png';
import jsimg from '../img/javascriptimg2.png';
import htmlimg from '../img/html5logo.jpg';
...
<br/>
    ...
    </section><div className="heading"><br/><br/>
      <h1 id="contactnav" className="contact">Contact Information</h1></div>
      <hr />
